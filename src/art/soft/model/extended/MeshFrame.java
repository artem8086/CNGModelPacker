...
public class MeshFrame extends MeshData {
    ...
    public final static int READ_MASK_FORM = 0x01;
    public final static int READ_MASK_FORCE_X = 0x02;
    public final static int READ_MASK_FORCE_Y = 0x04;
    public final static int READ_MASK_DMG_REGS = 0x08;
    public final static int READ_MASK_BULLETS = 0x10;
